...
import { TextShimmerWaveBasic } from "../homepage/textshimmer";
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-black dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-zinc-950 dark:bg-neutral-800 border border-neutral-500 dark:border-black p-2" />
              </div>
